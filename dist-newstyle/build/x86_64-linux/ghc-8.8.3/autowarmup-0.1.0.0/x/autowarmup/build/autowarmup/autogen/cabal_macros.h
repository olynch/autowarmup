...
/* package autowarmup-0.1.0.0 */
#ifndef VERSION_autowarmup
#define VERSION_autowarmup "0.1.0.0"
#endif /* VERSION_autowarmup */
#ifndef MIN_VERSION_autowarmup
#define MIN_VERSION_autowarmup(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_autowarmup */
...
#define CURRENT_COMPONENT_ID "autowarmup-0.1.0.0-inplace-autowarmup"
